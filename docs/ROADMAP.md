...
- 已完成 V1.1 首轮 E2E 页面还原验证，并根据缺口进入 V1.1.1 上下文可消费性补强。
...
状态：首轮已完成，报告见 `docs/e2e/B01_RESTORATION_VALIDATION.md`。
...
- 当前产物可支撑低保真结构还原。
- 高质量还原缺口集中在目标画板聚焦、图片尺寸映射、图层/文本、切图资源、Design Tokens 和 MCP 运行态 schema 自检。
